...
if(verlet_file ~= nil)then
    ...
    if(verlet ~= nil)then
        ...
        EntityAddComponent(verlet_controller, "LuaComponent", {
            script_source_file="mods/arcane_alchemy/files/scripts/misc/verlet_mover.lua",
            execute_on_added="1",
        ...
        EntityAddComponent(verlet, "LuaComponent", {
            script_source_file="mods/arcane_alchemy/files/scripts/misc/verlet_controller.lua",
            execute_on_added="1",
            execute_every_n_frame="0",
        })
